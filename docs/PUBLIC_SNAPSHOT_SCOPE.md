...
- Public-facing paper note from the Obsidian vault:
  `动态改进Orb SLAM3.md`
...
- Full private experiment records and 5.5 Pro feedback threads; these are
  submitted separately by the user when needed.
