...
public:
    ...
    struct InstanceClassSizePrior
    {
        ...
        double sumRadiusSq = 0.0;
        int count = 0;
        std::map<int, RadiusAccumulator> perInstance;
    };
    ...
    Instance* AddInstance(Instance* pInstance);
    void EraseMapPoint(MapPoint* pMP);
    void EraseKeyFrame(KeyFrame* pKF);
    void EraseInstance(int instanceId);
    ...
    void RecordInstanceClassSizePrior(int semanticLabel, double radius);
    void RecordInstanceClassSizePrior(int semanticLabel, int instanceId, double radius);
    std::map<int, InstanceClassSizePrior> GetAllInstanceClassSizePriors();
...
protected:
    ...
    std::map<int, Instance*> mmpInstances;
    std::map<int, InstanceClassSizePrior> mmInstanceClassSizePriors;
