...
class MapPoint
{
    ...
    void serialize(Archive & ar, const unsigned int version)
    {
        ...
        ar & mnInstanceId;
        ar & mnSemanticLabel;
        ar & mnFirstObservationFrame;
        ar & mnLastObservationFrame;
        ar & mnObservationCount;
        ar & mnLifecycleType;
...
public:
    ...
    enum LifecycleType
    {
        kStaticWorldMapPoint = 0,
        kDynamicInstanceObservationPoint = 1,
        kInstanceStructurePoint = 2
    };
...
public:
    ...
    int mnInstanceId;
    int mnSemanticLabel;
    long int mnFirstObservationFrame;
    long int mnLastObservationFrame;
    int mnObservationCount;
    int mnLifecycleType;
